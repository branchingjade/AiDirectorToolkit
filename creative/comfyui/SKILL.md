...
- `upscale-model-guide.md` — complete super-resolution model reference: 23+ open-source
  models (GAN/Transformer/Diffusion/Lightweight), 8 closed-source tools (Topaz,
  Magnific, NVIDIA, Adobe, etc.), 10+ ComfyUI upscale nodes, workflow templates,
  and decision matrices. Load this whenever the user asks about upscaling,
  super-resolution, or choosing/combining upscale models in ComfyUI workflows.
