...
- Write rewrite sections in Chinese by default; preserve dialogue, lyrics, and visible scene text in their original language. Only switch to English when the user explicitly requests it.
